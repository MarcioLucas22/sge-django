...
urlpatterns = [
    ...
    path('api/v1/suppliers/', views.SupplierCreateListAPIView.as_view(), name='suppliers-create-list-api-view'),
    path('api/v1/suppliers/<int:pk>', views.SupplierRetrieveUpdateDestroyAPIView.as_view(), name='suppliers-detail-api-view'),
]